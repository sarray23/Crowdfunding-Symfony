...
namespace Proxies\__CG__\Esprit\FrontOfficeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Esprit\FrontOfficeBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'Rl', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function getRl()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRl', []);
    ...
    public function setRl()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRl', []);
